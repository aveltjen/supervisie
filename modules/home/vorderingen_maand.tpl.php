...
<table width="100%" class="tekstnormal">
	...
	<tr>
		<td valign="top" align="center">
			...
			<tr class="tekstnormal" bgcolor="#EFEFEF">
     			 <td width="39px">&nbsp;</td>
     			 <td width="60px"><b>Post Nr.</b></td>
     			 <td width="80px"><b>Verm. Hv.</b></td>
     			 <td width="80px"><b>Vorige Hv.</b></td>
     			 <td width="80px"><b>Huidige Hv.</b></td>
     			 <td width="80px"><b>Totale Hv.</b></td>
     			 <td width="150px"><b>Bedrag (&euro;)</b></td>
			</tr>
			</table>
	...
	">
			...
			<!-- BEGIN posten -->
			<tr class="drukrows">
				 <td width="39px">{icon}</td>
     			 <td width="60px">{msNummer}</td>
     			 <td width="80px">{vmhv}</td>
     			 <td width="80px">{vorige}</td>
     			 <td width="80px">{huidige}</td>
     			 <td width="80px">{totaal}</td>
     			 <td width="150px">{bedrag}</td>
			</tr>
			<!-- END posten -->
			{empty}
			</table>
