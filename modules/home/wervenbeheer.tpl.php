				  ...
				  <tr>
				   ...
				   <td colspan="5" bgcolor="White" valign="top">
				   	<table width="100%" class="tekstinfo">
				   		<tr>
				   			<td align="left"><img src="images/verwijder.gif"> <b>Werf verwijderen:</b> Selectievakje eerst selecteren en vervolgens op het vuilbakje klikken. (Enkel mogelijk bij niet actieve werven!)</td>
					...
					<table width="100%" height="150" align="left" border="0" cellpadding="10" cellspacing="1" class="tableframe">
						<tr>
							<td align="left" valign="top" class="tableframe">
									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%" class="config">
										<!-- BEGIN Werflist -->
											<tr height="50">
												<td align="left" width=""><img src="images/box.png"></td>
												<td width="50" align="left"><b>{Number}</b> {description}</td>
												<td align="center">{checkbox} </td>
												<td align="center">{editwerf} </td>
												<td align="center">{archiveer} </td>
												<td align="center">{delete}{id} </td>
												<td align="center">{archief} </td>
											</tr>
										<!-- END Werflist -->
									</div>
									</table>
