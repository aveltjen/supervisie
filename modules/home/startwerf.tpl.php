				 		  ...
				 		  <table width="100%" height="200" border="0" align="left">
				 		  		...
				 		  		<tr>
									<td valign="top">
													...
													<td>
														<!-- <table><tr>
															<td><i>betekenis rijkleur</i></td>
															<td width="150px" class="lastinsert">=laatst gevorderd/gewijzigd</td>
														</tr></table> -->
									   			...
									   			<td>
									   				<table width="100%" border="0" class="tekstnormal">
									   					<tr>
									   						...
									   						<table>
									   							<tr>
									   								<td><img src="images/minmeer.png"></td>
									   						
									   								<td><a href="minmeerstaat.php?werven_ID={id}&id={user}" >Min/meer staat</a></td>
									   							</tr>
									   						</table>
									   						 </td>
									   					</tr>
