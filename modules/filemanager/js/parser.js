...
var fmParser = {
	...
	parseMain: function(json, contObj) {
		...
		html += '<table border="0" cellspacing="0" cellpadding="0" width="100%">\n';
		html += '<tr>\n';
		html += '<td><div class="fmTH1" style="width:' + titleWidth + '; padding:4px; white-space:nowrap; overflow:hidden" title="">Mijn werfdocumenten</div></td>\n';
	...
	parseTitleIcons: function(json) {
		...
		if(json.type == 'list') {
			...
			html += '<img src="' + fmWebPath + '/icn/refresh.png" width="11" height="14" style="cursor:pointer" title="' + tooltip + '" onClick="' + action + '"/>\n';
			html += '</td>\n';
