...
//Smodder voor initieel voorzien bedrag	ipv eigenlijke aanbesteding				

	switch ($werf) {
		case 229:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 120 730,96");
			break;

		case 230:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 186 020,39");	
			break;

		case 231:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 70 846,85");	
			break;

		case 232:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 41 163,74");	
			break;

		case 233:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 175 316,46");	
			break;

		case 234:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 79 053,67");	
			break;

		case 235:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 104 781,54");	
			break;

		case 236:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 58 841,17");	
			break;

		case 237:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 154 565,26");	
			break;

		case 238:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 55 107,98");	
			break;

		case 239:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 214 120,33");	
			break;

		case 241:
			$tpl->setVariable("label_aanbestedingsbedrag","Initieel voorziene bedrag bij aanbesteding:");
			$tpl->setVariable("vtotaal","".EUR." 138 926,02");	
			break;

		default:
			$tpl->setVariable("label_aanbestedingsbedrag","Totaal aanbestedingsbedrag:");
