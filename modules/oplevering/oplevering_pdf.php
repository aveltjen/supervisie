<?php session_start(); define("IN_SITE", true); define('EUR',chr(128));$root = $_SERVER['DOCUMENT_ROOT'];
	...
	switch ($werf) {
		case 229:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '120730.96';
			break;

		case 230:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '186020.39';	
			break;

		case 231:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '70846.85';	
			break;

		case 232:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '41163.74';	
			break;

		case 233:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '175316.46';	
			break;

		case 234:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '79053.67';	
			break;

		case 235:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '104781.54';	
			break;

		case 236:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '58841.17';	
			break;

		case 237:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '154565.26';	
			break;

		case 238:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '55107.98';	
			break;

		case 239:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '214120.33';	
			break;

		case 241:
			$label_aanbestedingsbedrag = "Initieel voorziene bedrag bij aanbesteding";
			$aanbesteding = '138926.02';
			break;

		default:
			$label_aanbestedingsbedrag = "Totaal aanbestedingsbedrag:";
...
// 	$oFpdf->Line(20, 40, 190, 40);
	...
	$oFpdf->Cell(20,'',''.$label_aanbestedingsbedrag.': '.EUR.' '.number_format($aanbesteding, 2, ',', ' ').'','','','L');
	$oFpdf->Ln();
